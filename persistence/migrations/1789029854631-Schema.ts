...
export class Schema1789029854631 implements MigrationInterface {
    name = 'Schema1789029854631'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "team" ("teamId" integer NOT NULL, "name" character varying NOT NULL, "primaryColor" character varying, "secondaryColor" character varying, "kitPrimaryColor" character varying, "kitSecondaryColor" character varying, "gradientAngle" integer NOT NULL DEFAULT '180', "gradientStops" jsonb NOT NULL DEFAULT '[]', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_e3c1e347fd4f0813cc7b2e2115b" PRIMARY KEY ("teamId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "player" ("playerId" integer NOT NULL, "name" character varying NOT NULL, "country" character varying, "height" character varying, "transferValue" character varying, "preferredFoot" character varying, "birthDate" character varying, "age" integer, "positions" jsonb, "injury" jsonb, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_ee365af3f201a00d9a917bc45b0" PRIMARY KEY ("playerId"))`);
